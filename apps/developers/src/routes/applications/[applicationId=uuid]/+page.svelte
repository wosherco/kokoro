...
<div class="container mx-auto p-6 space-y-8">
  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Card
        class="p-6 hover:bg-accent transition-colors cursor-pointer"
        onclick={() => window.open("https://docs.kokoro.ws", "_blank")}
      >
        <div class="flex items-center gap-4">
          ...
          <div class="space-y-1">
            ...
            <p class="text-sm text-muted-foreground">
              Learn how to integrate with Kokoro API
            </p>
          </div>
      ...
      <Card
        class="p-6 hover:bg-accent transition-colors cursor-pointer"
        onclick={() => window.open("https://docs.kokoro.ws/oauth", "_blank")}
      >
        <div class="flex items-center gap-4">
          <BookOpenIcon class="w-8 h-8" />
          <div class="space-y-1">
            <h3 class="font-semibold">OAuth Guide</h3>
            <p class="text-sm text-muted-foreground">
              Detailed guide for OAuth implementation
            </p>
          </div>
          <ExternalLinkIcon class="w-4 h-4 ml-auto" />
        </div>
