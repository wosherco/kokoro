...
server.tool(
  ...
  } (OUTDATED). If you already have today's date, it might be more precise, don't use this one.`,
  {
    ...
    dateFrom: z
      ...
      .optional()
      .describe(
        "A start date to filter memories by. Must be in ISO 8601 format or only a date."
      ),
    dateTo: z
      .string()
      .datetime({
      ...
      .optional()
      .describe(
        "An end date to filter memories by. Must be in ISO 8601 format or only a date."
      ),
